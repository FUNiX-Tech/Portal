...
UNIQUE_ASSIGNMENT_NAME = (
    "unique_assignment_name",
    "unique(title, course)",
    "Tên các assignment trong một course không được trùng nhau.",
)
UNIQUE_ASSIGNMENT_ORDER = (
    "unique_assignment_order",
    "unique(number, course)",
    "Số thứ tự của assignment trong một course không được trùng nhau.",
)
...
class Assignment(models.Model):
    ...
    course = fields.Many2one(
        "course_management", string="Môn học", required=True
    )
