...
UNIQUE_ASSIGNMENT_CRITERION_GROUP_NAME = (
    "unique_assignment_criterion_group_name",
    "unique(title, assignment)",
    "Tên nhóm tiêu chí trong một assignment không được giống nhau.",
)
UNIQUE_ASSIGNMENT_CRITERION_GROUP_ORDER = (
    "unique_assignment_criterion_group_order",
    "unique(number, assignment)",
    "Số thứ tự của tiêu chí trong một assignment không được giống nhau.",
)
