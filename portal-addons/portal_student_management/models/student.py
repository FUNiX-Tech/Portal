...
class Student(models.Model):
    ...
    email_verified_status = fields.Boolean(string='Xác thực email', default=False)
    created_at = fields.Datetime(string='Ngày tạo', readonly=True, default=fields.Datetime.now())
    updated_at = fields.Datetime(string='Ngày cập nhật', readonly=True, default=fields.Datetime.now())
